defmodule TicketifyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TicketifyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TicketifyWeb.Gettext, "errors", msg, opts)
    end
  end
